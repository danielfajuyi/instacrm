...
import { Instagram, Plus, BookmarkCheck, Menu, X, User, LogOut } from 'lucide-react'
                  ...
                  >
                    <div className="py-1">
                      ...
                      <button
                        ...
                        className="flex items-center space-x-2 w-full px-4 py-2 text-sm text-netflix-lightGray hover:text-white hover:bg-netflix-black"
                      >
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="border-t border-netflix-gray mt-4 pt-4">
              {user ? (
                <div className="px-4">
                  <p className="text-netflix-lightGray text-sm mb-2">{user.email}</p>
                  <button
                    onClick={handleSignOut}
